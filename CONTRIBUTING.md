# Contributing to @vllnt/convex-email
...
- No hardcoded provider/vendor — the transport is a host-supplied tag the host drives
...
Use [GitHub Issues](https://github.com/vllnt/convex-email/issues). For security vulnerabilities,
